...
public class AirlineReservation {
    ...
    public static void cancelReservation(Scanner scanner, Flight[] flights) {
        System.out.println("Select a flight for canceling the reservation:");
        for (int i = 0; i < flights.length; i++) {
            System.out.println((i + 1) + ". " + flights[i].name);
        }
        int flightIndex = scanner.nextInt() - 1;
        ...
        System.out.print("Enter seat number to cancel the reservation: ");
        int seatNumber = scanner.nextInt();
        ...
        if (selectedFlight.isSeatAvailable(seatNumber)) {
            ...
            System.out.println("Reservation for seat " + seatNumber + " on " + selectedFlight.name + " has been canceled.");
        }
    }
